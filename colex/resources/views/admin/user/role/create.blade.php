...
<div class="card card-custom">
    <div class="card-header flex-wrap py-3">
        <div class="card-title">
            <h3 class="card-label">Tambah Role</h3>
        </div>
    </div>
    <form action="{{ url('admin/users/roles') }}" method="post">
        @csrf
        <div class="card-body">
            <div class="mb-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="permission_ids[]" value="{{ $permission->id }}" id="permission_id" class="form-check-input">
